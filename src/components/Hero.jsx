        ...
        <div className="w-full max-w-2xl text-white">
          ...
          >
            ...
            >
              <Link
                to="/faculty"
                className="block rounded-xl bg-blue-600 px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-blue-700"
              >
                Explore Faculty →
              </Link>
            </motion.div>
            ...
            >
              <Link
                to="/departments"
                className="block rounded-xl border border-white/70 bg-white/5 px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-white hover:text-slate-900"
              >
                View Departments
              </Link>
            </motion.div>
          ...
          <motion.div
            ...
            className="mt-10 flex gap-12 border-t border-white/15 pt-6"
          >
